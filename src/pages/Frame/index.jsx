...
import { RatingBar, Img, Text, Button, Heading, SelectBox, Input } from "../../components";
        ...
        <div className="flex flex-col items-end justify-start w-full max-w-[1592px]">
                  ...
                  <div className="flex flex-col items-center justify-start w-full">
                                  ...
                                  <div className="flex flex-col items-center justify-start w-[31%] mb-[9px] gap-[72px]">
                                    <div className="flex flex-col items-center justify-start w-[59%] p-[3px] rounded-bl-[12px] rounded-br-[12px] bg-gray-50">
                                      <RatingBar
                                        ...
                                        size={10}
                                        starCount={4}
                                        className="flex justify-between h-2.5 w-2.5"
                                      />
                    ...
                    <div className="flex flex-row justify-between items-start w-[85%] mt-[85px]">
                      ...
                      <RatingBar
                        ...
                        size={10}
                        starCount={4}
                        className="flex justify-between h-2.5 w-2.5 mt-9"
                      />
                    </div>
                        ...
                        <div className="flex flex-col items-center justify-start w-full gap-[13px]">
                          <div className="flex flex-row justify-center w-[98%]">
                            <div className="flex flex-col items-start justify-start w-full gap-[7px]">
                              ...
                              <Heading as="h6" className="ml-[67px] !text-blue_gray-600_01">
                                Webbuilder 1
                              </Heading>
                              <Text size="lg" as="p" className="!text-blue_gray-600_01 !leading-6">
                                Computer Modern clasic with wix support
                              </Text>
                              <div className="flex flex-row justify-between items-end w-[71%]">
                                <Text size="xl" as="p" className="mb-px !text-blue_gray-600">
                                  $39.96
                                </Text>
                                <Text as="p" className="mb-px !text-blue_gray-300">
                    ...
                    <RatingBar
                      ...
                      size={10}
                      starCount={4}
                      className="flex justify-between h-2.5 w-2.5 mt-[88px]"
                    />
                  </div>
                </div>
              </div>
          ...
          <footer className="flex flex-col w-full">
            ...
            <div className="flex flex-row justify-start items-center w-full ml-[-517px]">
              ...
              <div className="flex flex-row justify-start items-center h-2 w-2 ml-[-410px]">
                <div className="flex flex-col items-center justify-start h-2 w-2">
                  <div className="flex flex-row justify-center items-start h-2 w-2 z-[1]">
                    <div className="h-2 w-2 z-[1] relative">
                      <Img
                        src="images/img_vector_gray_400.svg"
                        alt="vector_nine"
                        className="justify-center h-2 w-2 left-0 bottom-0 right-0 top-0 m-auto absolute"
                      />
                      <Img
                  ...
                  <Img src="images/img_vector_gray_400_1x2.svg" alt="vector_fifteen" className="h-px w-0.5 mt-[-2px]" />
                </div>
              </div>
            </div>
          </footer>
          <RatingBar
            ...
            size={10}
            starCount={4}
            className="flex justify-between h-2.5 w-2.5 mt-[150px] mr-[400px]"
          />
        </div>
      </div>
    </>
